...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="post-meta">
                <span class="meta-item"><i class="fas fa-user"></i>${data.author}</span>
                <span class="meta-item"><i class="fas fa-calendar-alt"></i>${typeof data.date === 'object' ? data.date.toISOString().split('T')[0] : data.date}</span>
            </div>
        </div>
        <div class="post">
